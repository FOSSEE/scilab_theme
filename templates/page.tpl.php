...
<noscript><p><img src="http://www.spoken-tutorial.iitb.ac.in/piwik/piwik.php?idsite=1" style="border:0;" alt="" /></p></noscript>
<!-- End Piwik Code -->
    ...
    <body class="<?php print $classes; ?>">
        ...
        <div id="page-wrapper">
			...
			<?php if (!($logged_in)): ?>
				...
				<?php else: ?>
				<div id="login1"><span id="login_c1"><strong>Welcome <a href="user"><?php print($user->name); ?></a></strong>&nbsp;&nbsp;<span id="logout_c1"><a href="<?php print $GLOBALS['base_url']; ?>/logout" style="text-decoration:none;"><strong>Logout</strong></a></div>
                            <?php endif; ?>
                            <?php endif; ?>
...
<noscript><p><img src="http://analytics.spoken-tutorial.org/piwik.php?idsite=5" style="border:0;" alt="" /></p></noscript>
<!-- End Piwik Code -->
